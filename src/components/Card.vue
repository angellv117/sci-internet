<template>
<div class="w-full my-4 max-w-sm bg-white border border-gray-200 rounded-lg shadow  hover:shadow-lg transition-shadow duration-300 hover:scale-105">
    <a>
    ...
    <div class="px-5 pb-5">
        ...
        <div v-if="price != ''">
            <div class="flex items-center justify-between">
                ...
                <button @click="clickButton" class="flex items-center justify-center gap-2 text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center ">
